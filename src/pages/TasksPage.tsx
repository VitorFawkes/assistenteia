    ...
    return (
        <div className="p-6 max-w-4xl mx-auto h-full overflow-y-auto">
            ...
            <Card className="mb-8 p-4">
                <form onSubmit={addTask} className="flex gap-4 flex-wrap items-center">
                    <input
                        type="text"
                        value={newTaskTitle}
                    ...
                    <Button type="submit" icon={Plus} className="bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-900/20">
                        Adicionar
                    </Button>
                </form>
            </Card>
